...
const Portfolio = () => {
  return (
    <section id='portfolio' className='h-auto md:py-60 py-32 relative overflow-visible'>
      ...
      <div className='lg:block hidden absolute -right-[16%] -z-10 -top-10 h-[250px] w-[300px] bg-zinc-800 bg-zinc'></div>
      <div data-scroll data-scroll-speed="-0.05" className='absolute -right-[5%] -z-20 top-16 h-[200px] w-[250px] bg-zinc-900 bg-zinc'></div>
